...
export const mockEvents = [
  {
    ...
    tax_rate: "0.04712",
    cleanup_fee: "200.00",
    labor_fee_override: null as string | null,
...
export const mockEventSections = [
  { id: "s01", event_id: "e01", name: "Personals", sort_order: 0, is_hidden: false, created_at: new Date(), updated_at: new Date() },
  { id: "s02", event_id: "e01", name: "Ceremony", sort_order: 1, is_hidden: false, created_at: new Date(), updated_at: new Date() },
  { id: "s03", event_id: "e01", name: "Reception", sort_order: 2, is_hidden: false, created_at: new Date(), updated_at: new Date() },
];
...
export const mockArrangements = [
  {
    ...
    sort_order: 0, is_no_recipe: false, is_hidden: false,
  ...
  },
  {
    ...
    internal_notes: null,
    sort_order: 1, is_no_recipe: false, is_hidden: false,
    repurposed_from_arrangement_ids: [],
    created_at: new Date(), updated_at: new Date(),
  },
  {
    ...
    sort_order: 2, is_no_recipe: false, is_hidden: false,
    repurposed_from_arrangement_ids: [],
    created_at: new Date(), updated_at: new Date(),
  },
  {
